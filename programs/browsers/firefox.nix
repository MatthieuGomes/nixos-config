{
  ...
  repos = "nur";
  branch = "unstable";
  packages = Inputs.pkgs-list.${repos}.${branch};
...
in {
  options.${name} = {
    enable = lib.mkEnableOption "Enables and configures Firefox.";
  };
  imports = [];
      ...
      profiles = {
        default = {
          ...
          settings = {
            ...
            "sidebar.installed.extensions" = "{${bitwarden-ID}}";
            "sidebar.main.tools" = "history,syncedtabs,bookmarks,{${bitwarden-ID}}";
